-- Génération de données faites par ChatGPT, voici les prompts --
-- Selon ma table Equipes.Equipe, insere les données pour toutes les equipes de la NHL en 2024-2025 --
-- Joueurs fictifs NHL, 10 par équipe --
-- Entraineurs, 4 par équipe --

-- Ici, il y eu un switch d'agent AI (Claude Sonnet 4.5), je lui ai renvoyé ma BD--
-- Une participation pour chaque joueur --
-- 32 match, tous les joueurs participent a un match, 5 joueurs par match, --
-- 2 entraineur par match --

-- Insertion de 32 équipes NHL (sans doublons)
...
--Tout ce bloc de code a été généré par IA parce qu'il n'arrive pas à être cohérent, il arrange ça propre cohérence avec ce code

/* ============================================================
   FIX / UPDATE COHERENCE GLOBALE
   - Recalcule les gagnants des matchs à partir des buts marqués
   - Recalcule VictoiresTotal par équipe
   - Recalcule ButsTotal par joueur
   ============================================================ */
